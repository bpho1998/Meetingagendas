...
def get_recent_events() -> list:
    ...
    SF's Legistar blocks ALL OData query params on /events (filter, orderby, top).
    Fetch with zero params and filter client-side.
    """
    all_events = legistar_get("events")
    
    # Client-side filter: past 7 days through 60 days out
